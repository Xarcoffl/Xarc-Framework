...
namespace Xarc {
    ...
    public class InputBridge : MonoBehaviour {
        ...
        void Start() {
            ...
            SteamVR_ActivateActionSetOnLoad XarcLoader = FindObjectOfType<SteamVR_ActivateActionSetOnLoad>();
            if (XarcLoader == null) {
                Debug.Log("SteamVR_ActivateActionSetOnLoad component not found - adding Xarc custom actions default.");
                XarcLoader = gameObject.AddComponent<SteamVR_ActivateActionSetOnLoad>();
                XarcLoader.actionSet = SteamVR_Actions.Xarc;
            }
        ...
        public virtual void UpdateSteamInput() {
            ...
            LeftThumbstickAxis = ApplyDeadZones(SteamVR_Actions.Xarc_LeftThumbstickAxis.axis, ThumbstickDeadzoneX, ThumbstickDeadzoneY);
            RightThumbstickAxis = ApplyDeadZones(SteamVR_Actions.Xarc_RightThumbstickAxis.axis, ThumbstickDeadzoneX, ThumbstickDeadzoneY);

            var prevBool = LeftThumbstick;
            LeftThumbstick = SteamVR_Actions.Xarc_LeftThumbstickDown.state;
            // LeftThumbstickDown = SteamVR_Actions.Xarc_LeftThumbstickDown.stateDown;
            ...
            RightThumbstick = SteamVR_Actions.Xarc_RightThumbstickDown.state;
            // RightThumbstickDown = SteamVR_Actions.Xarc_RightThumbstickDown.stateDown;
            RightThumbstickDown = prevBool == false && RightThumbstick == true;
            RightThumbstickUp = prevBool == true && RightThumbstick == false;
            
            LeftThumbNear = SteamVR_Actions.Xarc_LeftThumbstickNear.state;
            //LeftThumbNear = SteamVR_Actions.Xarc_LeftTrackpadNear.state;
            RightThumbNear = SteamVR_Actions.Xarc_RightThumbstickNear.state;
            //RightThumbNear = SteamVR_Actions.Xarc_RightTrackpadNear.state;

            var prevVal = LeftGrip;
            LeftGrip = LeftGrip = correctValue(SteamVR_Actions.Xarc_LeftGrip.axis);
            LeftGripDown = prevVal < _downThreshold && LeftGrip >= _downThreshold;

            prevVal = RightGrip;
            RightGrip = correctValue(SteamVR_Actions.Xarc_RightGrip.axis);
            RightGripDown = prevVal < _downThreshold && RightGrip >= _downThreshold;

            prevVal = LeftTrigger;
            LeftTrigger = correctValue(SteamVR_Actions.Xarc_LeftTrigger.axis);
            ...
            LeftTriggerNear = SteamVR_Actions.Xarc_LeftTriggerNear.state;

            prevVal = RightTrigger;
            RightTrigger = correctValue(SteamVR_Actions.Xarc_RightTrigger.axis);
            ...
            RightTriggerNear = SteamVR_Actions.Xarc_RightTriggerNear.state;

            AButton = SteamVR_Actions.Xarc_AButton.state;
            AButtonDown = SteamVR_Actions.Xarc_AButton.stateDown;
            AButtonUp = SteamVR_Actions.Xarc_AButton.stateUp;
            BButton = SteamVR_Actions.Xarc_BButton.state;
            BButtonDown = SteamVR_Actions.Xarc_BButton.stateDown;
            BButtonUp = SteamVR_Actions.Xarc_AButton.stateUp;
            XButton = SteamVR_Actions.Xarc_XButton.state;
            XButtonDown = SteamVR_Actions.Xarc_XButton.stateDown;
            XButtonUp = SteamVR_Actions.Xarc_XButton.stateUp;
            YButton = SteamVR_Actions.Xarc_YButton.state;
            YButtonDown = SteamVR_Actions.Xarc_YButton.stateDown;
            YButtonUp = SteamVR_Actions.Xarc_YButton.stateUp;

            // Hand Tracking (Ie Valve Knuckles Finger Tracking)
            LeftThumbCurl = SteamVR_Actions.Xarc_SkeletonLeftHand.thumbCurl;
            LeftIndexCurl = SteamVR_Actions.Xarc_SkeletonLeftHand.indexCurl;
            LeftMiddleCurl = SteamVR_Actions.Xarc_SkeletonLeftHand.middleCurl;
            LeftRingCurl = SteamVR_Actions.Xarc_SkeletonLeftHand.ringCurl;
            LeftPinkyCurl = SteamVR_Actions.Xarc_SkeletonLeftHand.pinkyCurl;

            RightThumbCurl = SteamVR_Actions.Xarc_SkeletonRightHand.thumbCurl;
            RightIndexCurl = SteamVR_Actions.Xarc_SkeletonRightHand.indexCurl;
            RightMiddleCurl = SteamVR_Actions.Xarc_SkeletonRightHand.middleCurl;
            RightRingCurl = SteamVR_Actions.Xarc_SkeletonRightHand.ringCurl;
            RightPinkyCurl = SteamVR_Actions.Xarc_SkeletonRightHand.pinkyCurl;

            //prevBool = StartButton;
            //StartButton = SteamVR_Actions.Xarc_StartButton.state;
            //StartButtonDown = prevBool == false && StartButton == true;

            //prevBool = BackButton;
            //BackButton = SteamVR_Actions.Xarc_BackButton.state;
...
#pragma warning restore 0618
        ...
        public virtual void SetTrackingOriginMode(TrackingOriginModeFlags trackingOrigin) {
            ...
            // *Removed from Xarc  v1.6 as XR plugin should properly set tracking space
#if UNITY_2019_4
...
#if STEAM_VR_SDK
                if (hand == ControllerHand.Right) {
                    if(SteamVR_Actions.Xarc_Haptic != null) {
                        SteamVR_Actions.Xarc_Haptic.Execute(0, duration, frequency, amplitude, SteamVR_Input_Sources.RightHand);
                    }
                }
                else {
                    if (SteamVR_Actions.Xarc_Haptic != null) {
                        SteamVR_Actions.Xarc_Haptic.Execute(0, duration, frequency, amplitude, SteamVR_Input_Sources.LeftHand);
                    }
                }                
#endif
            }
